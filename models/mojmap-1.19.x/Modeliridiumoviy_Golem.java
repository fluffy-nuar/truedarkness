...
public class Modeliridiumoviy_Golem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "iridiumoviy_golem"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r8 = bone2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(185, 0).addBox(-1.0F, -2.0F, 0.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, 1.0F, -9.0F, 0.3491F, -0.7854F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 68)
				.addBox(-11.0F, -33.0F, -4.0F, 22.0F, 7.0F, 9.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition cube_r9 = bone6.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(63, 69).addBox(-2.0F, -4.0F, 3.0F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.2618F, 0.0F, 0.4363F));

		PartDefinition cube_r10 = bone6.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(63, 77).addBox(-2.0F, -5.0F, 4.0F, 3.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.2618F, 0.0F, -0.3491F));

		PartDefinition cube_r11 = bone6
				.addOrReplaceChild("cube_r11",
						CubeListBuilder.create().texOffs(232, 0).addBox(-1.0F, -3.0F, -10.0F, 2.0F, 3.0F, 11.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -24.0F, 3.0F, 0.48F, 0.0F, 0.0F));

		PartDefinition cube_r12 = bone6.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(200, 0).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 27.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -24.0F, 2.0F, -1.3526F, 0.0F, 0.0F));

		PartDefinition cube_r13 = bone6
				.addOrReplaceChild("cube_r13",
						CubeListBuilder.create().texOffs(0, 35).addBox(-7.0F, -23.0F, 0.0F, 14.0F, 24.0F, 9.0F,
								new CubeDeformation(0.2F)),
						PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.288F, 0.0F, 0.0F));

		PartDefinition cube_r14 = bone6.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(46, 35).mirror()
						.addBox(0.0F, -21.0F, -4.0F, 12.0F, 24.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-11.0F, 1.0F, 4.0F, 0.2618F, 0.0916F, -0.3491F));

		PartDefinition cube_r15 = bone6.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(46, 2).addBox(-12.0F, -21.0F, -4.0F, 12.0F, 24.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.0F, 1.0F, 4.0F, 0.2618F, -0.0916F, 0.3491F));

		PartDefinition bone8 = body.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(196, 22).addBox(-7.0F,
				-34.0F, 4.0F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r16 = bone8.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 4.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -32.0F, 0.0F, 0.0F, -0.3491F, 0.3491F));

		PartDefinition cube_r17 = bone8.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(208, 12).addBox(-2.0F, -2.0F, 4.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = bone8.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = bone8.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(185, 12).addBox(-1.0F, -3.0F, 4.0F, 3.0F, 3.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -32.0F, 0.0F, 0.1745F, -0.0436F, 0.48F));

		PartDefinition cube_r21 = bone8.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(188, 13).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone9 = body.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(196, 22).addBox(-7.0F, -2.0F, 4.0F, 13.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone9.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = bone9.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(188, 13).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(80, 63).addBox(-2.0F, -4.0F, -4.0F, 7.0F, 24.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-17.0F, -28.0F, -4.0F, 0.0F, -0.0436F, 0.1745F));

		PartDefinition bone5 = right_arm.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(80, 95).addBox(-2.0F, 0.0F, -4.0F, 7.0F, 25.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 20.0F, 0.0F, -0.1309F, 0.0F, -0.2182F));

		PartDefinition bone10 = right_arm.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, 21.0F, 4.0F, 0.0F, -0.4363F, -0.3491F));

		PartDefinition cube_r30 = bone10.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 4.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -6.0F, 0.0F, -0.3491F, 0.3491F));

		PartDefinition cube_r31 = bone10.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(208, 12).addBox(-2.0F, -2.0F, 4.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = bone10.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -6.0F, -0.1309F, -0.0436F, -2.4871F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(98, 0).addBox(-5.0F, -4.0F, -4.0F, 7.0F, 24.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(17.0F, -28.0F, -4.0F, 0.0F, 0.0436F, -0.1745F));

		PartDefinition bone7 = left_arm.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(98, 32).addBox(-5.0F, 0.0F, -4.0F, 7.0F, 25.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 20.0F, 0.0F, -0.1309F, 0.0F, 0.2182F));

		PartDefinition bone12 = bone7.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(196, 22).addBox(-9.0F, -2.0F, 0.0F, 13.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r43 = bone12.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 4.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -4.0F, -0.2182F, 0.2618F, -2.4871F));

		PartDefinition bone11 = left_arm.addOrReplaceChild("bone11", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0F, -2.0F, -1.0F, 2.7489F, -0.6545F, 0.0F));

		PartDefinition cube_r44 = bone11.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.0F, -0.3491F, 0.3491F));

		PartDefinition cube_r45 = bone11.addOrReplaceChild("cube_r45",
				CubeListBuilder.create().texOffs(208, 12).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.0F, -0.0436F, -1.0472F));

		PartDefinition cube_r46 = bone11.addOrReplaceChild("cube_r46",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.3491F, 0.2182F, -0.3927F));

		PartDefinition cube_r47 = bone11.addOrReplaceChild("cube_r47",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, -0.2182F, 0.2618F, -0.3491F));

		PartDefinition cube_r48 = bone11.addOrReplaceChild("cube_r48",
				CubeListBuilder.create().texOffs(185, 12).addBox(-1.0F, -3.0F, 5.0F, 3.0F, 3.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.1745F, -0.0436F, 0.48F));

		PartDefinition cube_r49 = bone11.addOrReplaceChild("cube_r49",
				CubeListBuilder.create().texOffs(188, 13).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.3491F, 0.1745F, -2.1817F));

		PartDefinition cube_r50 = bone11.addOrReplaceChild("cube_r50",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, -0.2182F, 0.2618F, -2.4871F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(0, 84).addBox(-4.0F, 0.0F, -4.0F, 9.0F, 13.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, -2.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition bone3 = left_leg
				.addOrReplaceChild("bone3",
						CubeListBuilder.create().texOffs(0, 106).addBox(-4.0F, 0.0F, -4.0F, 9.0F, 13.0F, 9.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 13.0F, 0.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(36, 84).addBox(-6.0F, -1.0F, -4.0F, 9.0F, 13.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -1.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition bone4 = right_leg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(36, 106).addBox(-5.0F, 0.0F, -4.0F, 9.0F, 13.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 12.0F, 0.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition bone13 = right_leg.addOrReplaceChild("bone13", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0F, 12.0F, -1.0F, 2.7925F, -0.1309F, 0.0F));

		PartDefinition cube_r51 = bone13.addOrReplaceChild("cube_r51",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.0F, -0.3491F, 0.3491F));

		PartDefinition cube_r52 = bone13.addOrReplaceChild("cube_r52",
				CubeListBuilder.create().texOffs(208, 12).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.0F, -0.0436F, -1.0472F));

		PartDefinition cube_r53 = bone13.addOrReplaceChild("cube_r53",
				CubeListBuilder.create().texOffs(207, 11).addBox(-2.0F, -2.0F, 5.0F, 2.0F, 2.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.3491F, 0.2182F, -0.3927F));

		PartDefinition cube_r54 = bone13.addOrReplaceChild("cube_r54",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, -0.2182F, 0.2618F, -0.3491F));

		PartDefinition cube_r55 = bone13.addOrReplaceChild("cube_r55",
				CubeListBuilder.create().texOffs(185, 12).addBox(-1.0F, -3.0F, 5.0F, 3.0F, 3.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.1745F, -0.0436F, 0.48F));

		PartDefinition cube_r56 = bone13.addOrReplaceChild("cube_r56",
				CubeListBuilder.create().texOffs(188, 13).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, 0.3491F, 0.1745F, -2.1817F));

		PartDefinition cube_r57 = bone13.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(187, 12).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, -0.2182F, 0.2618F, -2.4871F));
