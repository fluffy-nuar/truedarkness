...
public class Modelgloomer_warrior<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gloomer_warrior"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition item = RightArm.addOrReplaceChild("item", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.0F, 15.0F, 3.0F, 1.309F, 0.0F, 0.0F));
		...
		PartDefinition bone3 = item2.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(0, 126)
						...
						.addBox(0.5F, -2.8132F, -1.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 122)
						...
						.addBox(0.5F, -3.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 120)
		...
		PartDefinition bone5 = item2.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(16, 120)
						.addBox(0.5F, -4.8132F, 0.5676F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 120)
						.addBox(0.5F, -4.8132F, -1.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 120)
						.addBox(0.5F, -4.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -12.0F));

		PartDefinition bone6 = item2.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -12.0F));
		...
		PartDefinition bone8 = item2.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(12, 118)
						.addBox(0.5F, -5.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 114)
						.addBox(0.5F, -7.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 112)
		...
		PartDefinition bone12 = item2.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(32, 118)
						.addBox(0.5F, -5.8132F, -7.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 114)
						.addBox(0.5F, -7.8132F, -7.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 112)
		...
		PartDefinition bone16 = item2.addOrReplaceChild("bone16", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -8.0F));
		...
		PartDefinition bone18 = item3.addOrReplaceChild("bone18", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -8.0F));
		...
		PartDefinition bone20 = item3.addOrReplaceChild("bone20",
				CubeListBuilder.create().texOffs(16, 110)
						.addBox(0.5F, -1.8132F, 0.5676F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 110)
						.addBox(0.5F, -1.8132F, -1.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 110)
						.addBox(0.5F, -1.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 108)
						.addBox(0.5F, -2.8132F, -2.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -12.0F));
		...
		PartDefinition bone21 = item3.addOrReplaceChild("bone21",
				CubeListBuilder.create().texOffs(32, 110)
						...
						.addBox(0.5F, -1.8132F, -5.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 108)
						...
						.addBox(0.5F, -3.8132F, -6.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 104)
		...
		PartDefinition bone22 = item3.addOrReplaceChild("bone22",
				CubeListBuilder.create().texOffs(48, 106)
						.addBox(0.5F, -3.8132F, -7.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 104)
						.addBox(0.5F, -4.8132F, -7.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 104)
						.addBox(0.5F, -4.8132F, -8.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -12.0F));
		...
		PartDefinition bone25 = item3.addOrReplaceChild("bone25", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, -8.0F));
		...
		PartDefinition bone27 = item3.addOrReplaceChild("bone27",
				CubeListBuilder.create().texOffs(40, 102)
						...
						.addBox(0.5F, -5.8132F, -10.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 100)
						.addBox(0.5F, -6.8132F, -10.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -8.0F));
		...
		PartDefinition bone31 = item3.addOrReplaceChild("bone31",
				CubeListBuilder.create().texOffs(48, 102)
						...
						.addBox(0.5F, -5.8132F, -13.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 100)
						...
						.addBox(0.5F, -7.8132F, -14.4324F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 96)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 32).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
