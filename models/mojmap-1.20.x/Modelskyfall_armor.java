...
public class Modelskyfall_armor<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "skyfall_armor"), "main");
	...
	public Modelskyfall_armor(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(32, 0)
				.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)).texOffs(0, 12).mirror()
				.addBox(-1.0F, -11.0F, 4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.5F)).mirror(false).texOffs(17, -7)
				.mirror().addBox(0.0F, -14.0F, 3.0F, 0.0F, 14.0F, 7.0F, new CubeDeformation(0.5F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Helmet_r1 = Head.addOrReplaceChild("Helmet_r1",
				CubeListBuilder.create().texOffs(6, -5).mirror()
						.addBox(2.5F, -25.0F, 4.0F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.25F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 13.0F, 0.0F, 0.0F, 0.4363F, 0.0F));

		PartDefinition Helmet_r2 = Head.addOrReplaceChild("Helmet_r2",
				CubeListBuilder.create().texOffs(6, -5).addBox(-2.5F, -25.0F, 4.0F, 0.0F, 10.0F, 5.0F,
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(40, 16).mirror()
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.8F)).mirror(false),
				PartPose.offset(5.0F, 2.0F, 0.0F));
