...
public class Modelbelt<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart Belt_air;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(24, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F,
		...
		PartDefinition Belt_air = partdefinition.addOrReplaceChild("Belt_air", CubeListBuilder.create(),
				PartPose.offset(0.0F, 13.0F, 0.0F));

		PartDefinition belt_part = Belt_air.addOrReplaceChild("belt_part",
				CubeListBuilder.create().texOffs(0, 8)
						.addBox(-1.5F, 0.0F, -0.5F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.45F)).texOffs(10, 8)
						.addBox(-1.5F, 0.0F, -0.5F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.7F)),
				PartPose.offsetAndRotation(4.0F, 10.0F, -1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition belt = Belt_air.addOrReplaceChild("belt",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -4.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.45F)).texOffs(0, 18)
						.addBox(-4.0F, -4.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.7F)),
