...
public class Modelcorrupted_skeleton<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "corrupted_skeleton"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition AddBone = Head.addOrReplaceChild("AddBone",
				CubeListBuilder.create().texOffs(96, 16)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(128, 19)
						.addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(0.0F, 2.0F, 1.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition Crystals = AddBone.addOrReplaceChild("Crystals", CubeListBuilder.create(),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(55, 56).addBox(
				-4.0F, -2.5F, 1.0F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, -3.0F));
		...
		PartDefinition CrystalsA3 = Body.addOrReplaceChild("CrystalsA3", CubeListBuilder.create(),
				PartPose.offset(0.0F, -4.0F, 6.0F));

		PartDefinition CrystalsAA = CrystalsA3.addOrReplaceChild("CrystalsAA",
				CubeListBuilder.create().texOffs(100, 9).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8994F, -0.2613F, 1.2215F));

		PartDefinition CrystalsBA = CrystalsA3.addOrReplaceChild("CrystalsBA", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.0F, 0.0F, -2.0F, -0.7854F, 0.0F, -0.2618F));

		PartDefinition Crystal_r1 = CrystalsBA.addOrReplaceChild("Crystal_r1",
				CubeListBuilder.create().texOffs(101, 1).addBox(-2.0F, -5.0F, -1.0F, 3.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -1.0F, 1.0F, 0.0F, 0.0F, -0.5672F));

		PartDefinition CrystalsCA = CrystalsA3.addOrReplaceChild("CrystalsCA",
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(47, 51)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(38, 51).mirror()
						.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.0F, 14.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(38, 51)
				.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 14.0F, 0.0F));
