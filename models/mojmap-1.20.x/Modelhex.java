...
public class Modelhex<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "hex"),
			"main");
	private final ModelPart Head;
	private final ModelPart BigCrystal;
	private final ModelPart BodyFirst;
	private final ModelPart CrystalGroupB;
	private final ModelPart BodySecond;
	private final ModelPart CrystalGroupA;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition BigCrystal = partdefinition.addOrReplaceChild("BigCrystal",
				CubeListBuilder.create().texOffs(0, 34).addBox(-7.0F, -7.0F, 0.0F, 7.0F, 7.0F, 7.0F,
		...
		PartDefinition BodyFirst = partdefinition.addOrReplaceChild("BodyFirst",
				CubeListBuilder.create().texOffs(12, 24)
						.addBox(5.0F, -5.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-8.0F, -5.0F, -4.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-1.0F, -3.0F, -9.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-1.0F, -1.0F, 5.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 10.0F, 0.0F));

		PartDefinition CrystalGroupB = partdefinition.addOrReplaceChild("CrystalGroupB", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition CrystalGroupBA = CrystalGroupB.addOrReplaceChild("CrystalGroupBA",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.0F, -3.0F, 1.0F, 3.0F, 3.0F, 3.0F,
		...
		PartDefinition CrystalGroupBB = CrystalGroupB.addOrReplaceChild("CrystalGroupBB",
				CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition CrystalGroupBC = CrystalGroupB.addOrReplaceChild("CrystalGroupBC",
				CubeListBuilder.create().texOffs(12, 16).addBox(-6.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -4.0F, -3.0F, 0.3054F, 0.0F, -0.2618F));

		PartDefinition CrystalGroupBD = CrystalGroupB.addOrReplaceChild("CrystalGroupBD",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition BodySecond = partdefinition.addOrReplaceChild("BodySecond",
				CubeListBuilder.create().texOffs(12, 24)
						.addBox(3.0F, -4.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-6.0F, -4.0F, -4.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-1.0F, -3.0F, -7.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
						.addBox(-2.0F, -1.0F, 2.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.0F, 0.0F));

		PartDefinition CrystalGroupA = partdefinition.addOrReplaceChild("CrystalGroupA", CubeListBuilder.create(),
		...
		PartDefinition CrystalGroupAC = CrystalGroupA.addOrReplaceChild("CrystalGroupAC",
				CubeListBuilder.create().texOffs(12, 16).addBox(-6.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -5.0F, -3.0F, 0.3054F, 0.0F, -0.2618F));

		PartDefinition CrystalGroupAD = CrystalGroupA.addOrReplaceChild("CrystalGroupAD",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
