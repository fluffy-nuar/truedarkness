...
public class Modelfantal_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fantal_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(32, 0)
				...
				.addBox(-4.5F, -8.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)).texOffs(32, 0).mirror()
				.addBox(2.5F, -8.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)).mirror(false).texOffs(26, 1)
				.mirror().addBox(-1.0F, -10.0F, -6.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.5F)).mirror(false)
				.texOffs(0, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.8F)),
