...
import exp.fluffynuar.truedarkness.procedures.LightShroomItemPriZaviershieniiIspolzovaniiaProcedure;
...
public class LightShroomItemItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		LightShroomItemPriZaviershieniiIspolzovaniiaProcedure.execute(entity);
		return retval;
	}
