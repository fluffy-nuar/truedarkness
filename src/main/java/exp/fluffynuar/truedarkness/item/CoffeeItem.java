...
import exp.fluffynuar.truedarkness.procedures.CoffeeIghrokZakanchivaietIspolzovaniiePriedmietaProcedure;
...
public class CoffeeItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		CoffeeIghrokZakanchivaietIspolzovaniiePriedmietaProcedure.execute(entity);
