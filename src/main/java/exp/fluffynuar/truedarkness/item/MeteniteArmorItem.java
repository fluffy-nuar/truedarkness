...
public abstract class MeteniteArmorItem extends ArmorItem {
	public MeteniteArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(TruedarknessModItems.METENITE_INGOT.get()));
			}
	...
	public static class Helmet extends MeteniteArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "truedarkness:textures/entities/metenite_armor.png";
		}
	}

	public static class Chestplate extends MeteniteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends MeteniteArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "truedarkness:textures/models/armor/metenite_armor__layer_2.png";
		}
	}

	public static class Boots extends MeteniteArmorItem {
		public Boots() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "truedarkness:textures/models/armor/metenite_armor__layer_1.png";
		}
	}
}
