...
public abstract class FireniteArmorItem extends ArmorItem {
	...
	public static class Helmet extends FireniteArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends FireniteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FireniteArmorItem {
		public Leggings() {
	...
	public static class Boots extends FireniteArmorItem {
		public Boots() {
