...
import exp.fluffynuar.truedarkness.init.TruedarknessModFeatures;
...
public class TruedarknessMod {
	public static final Logger LOGGER = LogManager.getLogger(TruedarknessMod.class);
	public static final String MODID = "truedarkness";

	public TruedarknessMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		TruedarknessModSounds.REGISTRY.register(bus);
		TruedarknessModBlocks.REGISTRY.register(bus);
		TruedarknessModBlockEntities.REGISTRY.register(bus);
		TruedarknessModItems.REGISTRY.register(bus);
		TruedarknessModEntities.REGISTRY.register(bus);
		...
		TruedarknessModMenus.REGISTRY.register(bus);
	}
