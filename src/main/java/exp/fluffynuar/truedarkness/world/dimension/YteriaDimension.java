...
package exp.fluffynuar.truedarkness.world.dimension;
...
import exp.fluffynuar.truedarkness.procedures.YteriaKoghdaIghrokPokidaietIzmierieniieProcedure;
import exp.fluffynuar.truedarkness.procedures.YteriaIesliIghrokVkhoditVIzmierieniieProcedure;
...
public class YteriaDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("truedarkness:yteria"), customEffect);
		}
	}
