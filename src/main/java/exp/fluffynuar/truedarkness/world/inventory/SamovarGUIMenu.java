...
import exp.fluffynuar.truedarkness.procedures.SamovarGUIPokaEtotGUIOtkrytProcedure;
import exp.fluffynuar.truedarkness.procedures.BlacksmiteForgeGUIPriZakrytiiGUIProcedure;
import exp.fluffynuar.truedarkness.network.SamovarGUISlotMessage;
import exp.fluffynuar.truedarkness.init.TruedarknessModMenus;
import exp.fluffynuar.truedarkness.TruedarknessMod;

@Mod.EventBusSubscriber
public class SamovarGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SamovarGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TruedarknessModMenus.SAMOVAR_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			TruedarknessMod.PACKET_HANDLER.sendToServer(new SamovarGUISlotMessage(slotid, x, y, z, ctype, meta));
			SamovarGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof SamovarGUIMenu) {
