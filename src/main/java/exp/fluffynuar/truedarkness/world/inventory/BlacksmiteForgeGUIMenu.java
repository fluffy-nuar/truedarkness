...
public class BlacksmiteForgeGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlacksmiteForgeGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TruedarknessModMenus.BLACKSMITE_FORGE_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			TruedarknessMod.PACKET_HANDLER.sendToServer(new BlacksmiteForgeGUISlotMessage(slotid, x, y, z, ctype, meta));
			BlacksmiteForgeGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BlacksmiteForgeGUIMenu) {
