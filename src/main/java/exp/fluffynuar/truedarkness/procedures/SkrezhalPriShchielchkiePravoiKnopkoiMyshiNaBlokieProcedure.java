		...
		if (entity.isShiftKeyDown()) {
			if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("truedarkness:yteria"))) {
				if (itemstack.getOrCreateTag().getBoolean("Tablet_accept")) {
					itemstack.getOrCreateTag().putBoolean("Tablet_accept", false);
					itemstack.getOrCreateTag().putDouble("Tablet_X", 0);
					itemstack.getOrCreateTag().putDouble("Tablet_Y", 0);
					itemstack.getOrCreateTag().putDouble("Tablet_Z", 0);
					if (entity instanceof Player _player)
						_player.getCooldowns().addCooldown(itemstack.getItem(), 40);
				} else {
					itemstack.getOrCreateTag().putDouble("Tablet_X", (entity.getX()));
					itemstack.getOrCreateTag().putDouble("Tablet_Y", (entity.getY()));
					itemstack.getOrCreateTag().putDouble("Tablet_Z", (entity.getZ()));
					itemstack.getOrCreateTag().putBoolean("Tablet_accept", true);
					if (entity instanceof Player _player)
						_player.getCooldowns().addCooldown(itemstack.getItem(), 40);
				}
			} else if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD) {
				if (itemstack.getOrCreateTag().getBoolean("Tablet_accept_OW")) {
					itemstack.getOrCreateTag().putBoolean("Tablet_accept_OW", false);
					itemstack.getOrCreateTag().putDouble("Tablet_X_OW", 0);
					itemstack.getOrCreateTag().putDouble("Tablet_Y_OW", 0);
					itemstack.getOrCreateTag().putDouble("Tablet_Z_OW", 0);
					if (entity instanceof Player _player)
						_player.getCooldowns().addCooldown(itemstack.getItem(), 40);
				} else {
					itemstack.getOrCreateTag().putDouble("Tablet_X_OW", (entity.getX()));
					itemstack.getOrCreateTag().putDouble("Tablet_Y_OW", (entity.getY()));
					itemstack.getOrCreateTag().putDouble("Tablet_Z_OW", (entity.getZ()));
					itemstack.getOrCreateTag().putBoolean("Tablet_accept_OW", true);
					if (entity instanceof Player _player)
						_player.getCooldowns().addCooldown(itemstack.getItem(), 40);
				}
			}
		} else {
			if (!(entity instanceof LivingEntity _livEnt57 && _livEnt57.hasEffect(TruedarknessModMobEffects.TABLET_BREAKING.get()))) {
				if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD
					...
					TruedarknessMod.queueServerWork(20, () -> {
						if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD
							...
							if (entity instanceof Player _player && !_player.level().isClientSide())
								_player.displayClientMessage(Component.literal((Component.translatable("item.truedarkness.tablet.teleport.1").getString())), false);
							TruedarknessMod.queueServerWork(60, () -> {
								if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD
									...
									if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
										_entity.addEffect(new MobEffectInstance(TruedarknessModMobEffects.TABLET_BREAKING.get(), (int) (60 * 20 * 8), 0, true, false));
								}
							});
						}
					});
						...
						new ResourceLocation("truedarkness:yteria")) && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TruedarknessModItems.TABLET.get()) {
					if ((entity.getCapability(TruedarknessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TruedarknessModVariables.PlayerVariables())).corrupt_second <= 5) {
						...
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(TruedarknessModMobEffects.TABLET_BREAKING.get(), 2400, 0, true, false));
					} else {
