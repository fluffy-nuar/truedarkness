...
public class PriIzmeneniiSlota2Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if (!((PassiveEffectGetProcedure.execute(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(2)).getItem() : ItemStack.EMPTY)).equals(""))) {
