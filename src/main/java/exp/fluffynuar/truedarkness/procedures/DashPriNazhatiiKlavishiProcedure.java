...
public class DashPriNazhatiiKlavishiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!entity.isShiftKeyDown()) {
			if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(TruedarknessModItems.SOUL_SPOOL.get())) : false)
					&& !(entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(TruedarknessModMobEffects.SOULSTEAL_SPOOL_COOLDOWN.get()))
				...
				if (entity instanceof LivingEntity _livEnt11 && _livEnt11.hasEffect(TruedarknessModMobEffects.SOUL_SPEED.get())) {
			...
			if ((entity.getCapability(TruedarknessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TruedarknessModVariables.PlayerVariables())).SculkedMana >= 10
					|| (entity.getCapability(TruedarknessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TruedarknessModVariables.PlayerVariables())).SculkedMana >= 5
					...
					|| (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(TruedarknessModItems.ECHO_SPOOL.get())) : false)
							&& !(entity instanceof LivingEntity _livEnt38 && _livEnt38.hasEffect(TruedarknessModMobEffects.SOULSTEAL_SPOOL_COOLDOWN.get())) && new Object() {
								public boolean checkGamemode(Entity _ent) {
									if (_ent instanceof ServerPlayer _serverPlayer) {
										return _serverPlayer.gameMode.getGameModeForPlayer() == GameType.CREATIVE;
									} else if (_ent.level().isClientSide() && _ent instanceof Player _player) {
				...
				if (!(entity instanceof LivingEntity _livEnt40 && _livEnt40.hasEffect(MobEffects.MOVEMENT_SPEED))) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
