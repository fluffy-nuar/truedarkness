...
public class PortalKoghdaIghrokStalkivaietsiaSEtoiSushchnostiuProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity sourceentity) {
		...
		if ((world instanceof Level _lvl ? _lvl.dimension() : Level.OVERWORLD) == Level.OVERWORLD) {
			...
			sourceentity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.GENERIC)), 5);
		}
	}
}
