...
public class SoulstealHeartKazhdyiTikVRukieProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(TruedarknessModMobEffects.HARP_ECHO.get())
				&& (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TruedarknessModItems.FANTAL_HEART.get()) {
			...
			TruedarknessMod.queueServerWork(20, () -> {
				if (entity instanceof LivingEntity _livEnt5 && _livEnt5.hasEffect(TruedarknessModMobEffects.HARP_ECHO.get())
					...
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(TruedarknessModItems.ECHO_HEART.get()).copy();
