...
public class SoulstealWingsPriShchielchkiePKMPoBlokuProcedure {
				...
				TruedarknessMod.queueServerWork(60, () -> {
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TruedarknessModItems.SOULSTEAL_WINGS.get()) {
						...
						if (entity instanceof Player _player && !_player.level().isClientSide())
							_player.displayClientMessage(Component.literal(("\u00A7b" + Component.translatable("soul.wings.you_can").getString())), true);
						if (entity instanceof LivingEntity _entity) {
