...
public class GeneralArmorSobytiieTaktovKirasyProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).getItem() == TruedarknessModItems.GENERAL_LEGGINGS.get()
			...
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("truedarkness:general_armor_adv"));
