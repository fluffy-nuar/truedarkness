...
public class HangingCorruptNaPrimierieStrukturySghienierirovanoProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world.isEmptyBlock(BlockPos.containing(x, y - 1, z)) || (world.getBlockState(BlockPos.containing(x, y - 1, z))) == Blocks.WATER.defaultBlockState()) {
			...
			HangingCorruptNaPrimierieStrukturySghienierirovanoProcedure.execute(world, x, (y - 1), z);
		}
	}
}
