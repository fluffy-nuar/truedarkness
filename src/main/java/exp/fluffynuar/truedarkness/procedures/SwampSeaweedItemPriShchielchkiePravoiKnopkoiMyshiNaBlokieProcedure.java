...
public class SwampSeaweedItemPriShchielchkiePravoiKnopkoiMyshiNaBlokieProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TruedarknessModItems.SWAMP_SEAWEED_ITEM.get()) {
			if (world.getBlockState(BlockPos.containing(x, y, z)).canOcclude()
					&& ((world.getBlockState(BlockPos.containing(x, y + 1, z))) == Blocks.WATER.defaultBlockState() || (world.getBlockState(BlockPos.containing(x, y + 1, z))) == Blocks.WATER.defaultBlockState())) {
				{
				...
				if (!(new Object() {
					...
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(TruedarknessModItems.SWAMP_SEAWEED_ITEM.get());
