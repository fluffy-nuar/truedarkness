...
public class GrimTreeNaPrimierieStrukturySghienierirovano3Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _serverworld) {
			StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("truedarkness", "grim_tree_3"));
			if (template != null) {
