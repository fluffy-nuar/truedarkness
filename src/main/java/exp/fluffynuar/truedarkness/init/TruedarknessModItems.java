...
public class TruedarknessModItems {
	...
	public static final RegistryObject<Item> BLINK_MUSHROOM_STEM = block(TruedarknessModBlocks.BLINK_MUSHROOM_STEM);
	...
	public static final RegistryObject<Item> SIDE_SPELL_0 = REGISTRY.register("side_spell_0", () -> new SideSpell0Item());
	public static final RegistryObject<Item> SIDE_SPELL_1 = REGISTRY.register("side_spell_1", () -> new SideSpell1Item());
	public static final RegistryObject<Item> SIDE_SPELL_2 = REGISTRY.register("side_spell_2", () -> new SideSpell2Item());
	public static final RegistryObject<Item> SIDE_SPELL_3 = REGISTRY.register("side_spell_3", () -> new SideSpell3Item());
	public static final RegistryObject<Item> UP_SPELL_0 = REGISTRY.register("up_spell_0", () -> new UpSpell0Item());
	public static final RegistryObject<Item> UP_SPELL_1 = REGISTRY.register("up_spell_1", () -> new UpSpell1Item());
	public static final RegistryObject<Item> UP_SPELL_2 = REGISTRY.register("up_spell_2", () -> new UpSpell2Item());
	public static final RegistryObject<Item> UP_SPELL_3 = REGISTRY.register("up_spell_3", () -> new UpSpell3Item());
	public static final RegistryObject<Item> DOWN_SPELL_0 = REGISTRY.register("down_spell_0", () -> new DownSpell0Item());
	public static final RegistryObject<Item> DOWN_SPELL_1 = REGISTRY.register("down_spell_1", () -> new DownSpell1Item());
	public static final RegistryObject<Item> DOWN_SPELL_2 = REGISTRY.register("down_spell_2", () -> new DownSpell2Item());
	public static final RegistryObject<Item> DOWN_SPELL_3 = REGISTRY.register("down_spell_3", () -> new DownSpell3Item());
	...
	public static final RegistryObject<Item> RAW_CURSED_METAL = REGISTRY.register("raw_cursed_metal", () -> new RawCursedMetalItem());
	...
	public static final RegistryObject<Item> MARINITE_UPGRADE = REGISTRY.register("marinite_upgrade", () -> new MariniteUpgradeItem());
	...
	public static final RegistryObject<Item> SOULSTEAL_SPOOL = REGISTRY.register("soulsteal_spool", () -> new StoneSpoolItem());
	...
	public static final RegistryObject<Item> MANA_REDACTOR_PLUS = REGISTRY.register("mana_redactor_plus", () -> new ManaRedactorPlusItem());
	public static final RegistryObject<Item> MANA_REDACTOR_MINUS = REGISTRY.register("mana_redactor_minus", () -> new ManaRedactorMinusItem());
	public static final RegistryObject<Item> ECHO_SANDGLASS = REGISTRY.register("echo_sandglass", () -> new EchoSandglassItem());
	public static final RegistryObject<Item> ECHO_RING = REGISTRY.register("echo_ring", () -> new SculkRing1Item());
	...
	public static final RegistryObject<Item> GLOW_BUG_SPAWN_EGG = REGISTRY.register("glow_bug_spawn_egg", () -> new ForgeSpawnEggItem(TruedarknessModEntities.GLOW_BUG, -13710930, -14336193, new Item.Properties()));
	public static final RegistryObject<Item> MINER_SPAWN_EGG = REGISTRY.register("miner_spawn_egg", () -> new ForgeSpawnEggItem(TruedarknessModEntities.MINER, -8982567, -9469310, new Item.Properties()));
	...
	public static final RegistryObject<Item> CORRUPTED_HUMAN_SPAWN_EGG = REGISTRY.register("corrupted_human_spawn_egg", () -> new ForgeSpawnEggItem(TruedarknessModEntities.CORRUPTED_HUMAN, -12765877, -8693856, new Item.Properties()));
	public static final RegistryObject<Item> CORRUPTED_MAGE_SPAWN_EGG = REGISTRY.register("corrupted_mage_spawn_egg", () -> new ForgeSpawnEggItem(TruedarknessModEntities.CORRUPTED_MAGE, -14739413, -9752918, new Item.Properties()));
	public static final RegistryObject<Item> SOULSTEAL_WARRIOR_SPAWN_EGG = REGISTRY.register("soulsteal_warrior_spawn_egg", () -> new ForgeSpawnEggItem(TruedarknessModEntities.SOULSTEAL_WARRIOR, -13683137, -9752918, new Item.Properties()));
	...
	public static final RegistryObject<Item> LIGHTED_VINE_ACTIVE_0 = block(TruedarknessModBlocks.LIGHTED_VINE_ACTIVE_0);
