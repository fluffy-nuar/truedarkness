...
public class CorruptedMageEntity extends Monster implements RangedAttackMob {
	...
	public CorruptedMageEntity(EntityType<CorruptedMageEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(TruedarknessModItems.CURSED_RING.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(Items.LEATHER_CHESTPLATE));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(TruedarknessModItems.ERIDIUM_BONE.get()));
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		ShandarahProjectileEntity.shoot(this, target);
	}
