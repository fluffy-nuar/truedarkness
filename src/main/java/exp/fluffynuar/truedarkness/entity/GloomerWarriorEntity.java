...
public class GloomerWarriorEntity extends PathfinderMob {
	public static final EntityDataAccessor<Integer> DATA_gloomer_price = SynchedEntityData.defineId(GloomerWarriorEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<String> DATA_gloomer_trade = SynchedEntityData.defineId(GloomerWarriorEntity.class, EntityDataSerializers.STRING);

	public GloomerWarriorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.GLOOMER_WARRIOR.get(), world);
	}

	public GloomerWarriorEntity(EntityType<GloomerWarriorEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 4;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(TruedarknessModEntities.GLOOMER_WARRIOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
