...
public class CorruptedKnightEntity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_aggresive = SynchedEntityData.defineId(CorruptedKnightEntity.class, EntityDataSerializers.BOOLEAN);

	public CorruptedKnightEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.CORRUPTED_KNIGHT.get(), world);
	}

	public CorruptedKnightEntity(EntityType<CorruptedKnightEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 6;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TruedarknessModItems.CORRUPTED_FIRENITE_SWORD.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(TruedarknessModItems.CORRUPTED_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(TruedarknessModItems.CORRUPTED_CHESTPLATE.get()));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("truedarkness:entity.corrupted_knight.hurt"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TruedarknessModEntities.CORRUPTED_KNIGHT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
