...
public class SwampSalmonEntity extends PathfinderMob {
	public SwampSalmonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.SWAMP_COD_ENTITY.get(), world);
	}

	public SwampSalmonEntity(EntityType<SwampSalmonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(TruedarknessModEntities.SWAMP_COD_ENTITY.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
