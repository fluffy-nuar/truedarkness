...
public class EridiumZombieEntity extends Monster {
	public EridiumZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.ERIDIUM_ZOMBIE.get(), world);
	}

	public EridiumZombieEntity(EntityType<EridiumZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 3;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TruedarknessModItems.ERIDIUM_SHARD.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(TruedarknessModEntities.ERIDIUM_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
