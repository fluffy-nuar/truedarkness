...
public class CorruptedSkeletonEntity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_aggresive = SynchedEntityData.defineId(CorruptedSkeletonEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_spawning = SynchedEntityData.defineId(CorruptedSkeletonEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_timer = SynchedEntityData.defineId(CorruptedSkeletonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_his_y = SynchedEntityData.defineId(CorruptedSkeletonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_spawn_time = SynchedEntityData.defineId(CorruptedSkeletonEntity.class, EntityDataSerializers.INT);

	public CorruptedSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.CORRUPTED_SKELETON.get(), world);
	}

	public CorruptedSkeletonEntity(EntityType<CorruptedSkeletonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, false) {
			...
			public boolean canUse() {
				double x = CorruptedSkeletonEntity.this.getX();
				double y = CorruptedSkeletonEntity.this.getY();
				double z = CorruptedSkeletonEntity.this.getZ();
				Entity entity = CorruptedSkeletonEntity.this;
				Level world = CorruptedSkeletonEntity.this.level();
