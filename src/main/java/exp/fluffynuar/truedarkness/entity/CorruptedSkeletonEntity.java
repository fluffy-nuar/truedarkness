...
public class CorruptedSkeletonEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CorruptedSkeletonEntity retval = TruedarknessModEntities.CORRUPTED_SKELETON.get().create(serverWorld);
