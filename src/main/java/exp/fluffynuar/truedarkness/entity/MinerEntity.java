...
import exp.fluffynuar.truedarkness.procedures.FungumKoghdaEtotObiektUbivaietDrughoghoProcedure;
import exp.fluffynuar.truedarkness.init.TruedarknessModEntities;

public class MinerEntity extends Monster {
	public MinerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TruedarknessModEntities.MINER.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("truedarkness:entity.miner.ambient"));
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("truedarkness:entity.miner.death"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TruedarknessModEntities.MINER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
