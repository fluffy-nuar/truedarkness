...
import exp.fluffynuar.truedarkness.procedures.UseMagicPriNazhatiiKlavishiProcedure;
...
public class UseMagicMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			UseMagicPriNazhatiiKlavishiProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		TruedarknessMod.addNetworkMessage(UseMagicMessage.class, UseMagicMessage::buffer, UseMagicMessage::new, UseMagicMessage::handler);
	}
}
