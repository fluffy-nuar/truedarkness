...
public class Modelcrown<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("truedarkness", "modelcrown"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition crown = Head.addOrReplaceChild("crown", CubeListBuilder.create().texOffs(4, 1).addBox(-3.0F, -8.0F, -3.0F, 7.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
