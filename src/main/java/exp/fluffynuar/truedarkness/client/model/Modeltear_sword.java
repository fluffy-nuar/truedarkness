...
public class Modeltear_sword<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("truedarkness", "modeltear_sword"), "main");
	public final ModelPart item;

	public Modeltear_sword(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition item = partdefinition.addOrReplaceChild("item",
				...
				PartPose.offset(0.0F, 33.0F, 0.5F));
